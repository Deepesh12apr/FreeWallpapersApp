...
public class FullScreenViewActivity extends Activity implements OnClickListener {
	...
	private LinearLayout llSetWallpaper, llDownloadWallpaper,share;
	private Utils utils;
	...
	public void onClick(View v) {
		...
		case R.id.share:
			...
			Toast.makeText(this, "launching share", Toast.LENGTH_LONG).show();
			...
			intent.putExtra(android.content.Intent.EXTRA_TEXT, "send to");
